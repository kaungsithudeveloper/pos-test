    ...
    <div class="container-fluid main-container">
        <div class="d-flex">
            ...
            <a class="logo-horizontal " href="index.html">
                <img src="{{ url('backend/assets/images/brand/logo-white.png') }}" class="header-brand-img desktop-logo" alt="logo">
                <img src="{{ url('backend/assets/images/brand/logo-dark.png') }}" class="header-brand-img light-logo1"
                    alt="logo">
            </a>
            <!-- LOGO -->
                        ...
                        <div class="d-flex order-lg-2">
                                    ...
                                    <div class="header-dropdown-list message-menu">
                                        <div class="dropdown-item d-flex p-4">
                                            ...
                                            <span
                                                ...
                                                data-bs-image-src="{{ url('backend/assets/images/products/3.jpg') }}"></span>
                                            <div class="wd-50p">
                                        ...
                                        <div class="dropdown-item d-flex p-4">
                                            ...
                                            <span
                                                class="avatar avatar-xl br-5 me-3 align-self-center cover-image"
                                                data-bs-image-src="{{ url('backend/assets/images/products/5.jpg') }}"></span>
                                            <div class="wd-50p">
                                        ...
                                        <div class="dropdown-item d-flex p-4">
                                            ...
                                            <span
                                                class="avatar avatar-xl br-5 me-3 align-self-center cover-image"
                                                data-bs-image-src="{{ url('backend/assets/images/products/7.jpg') }}"></span>
                                            <div class="wd-50p">
                                        ...
                                        <div class="dropdown-item d-flex p-4">
                                            ...
                                            <span
                                                class="avatar avatar-xl br-5 me-3 align-self-center cover-image"
                                                data-bs-image-src="{{ url('backend/assets/images/products/1.jpg') }}"></span>
                                            <div class="wd-50p">
                                        ...
                                        <div class="dropdown-item d-flex p-4">
                                            ...
                                            <span
                                                class="avatar avatar-xl br-5 me-3 align-self-center cover-image"
                                                data-bs-image-src="{{ url('backend/assets/images/products/2.jpg') }}"></span>
                                            <div class="wd-50p">
                                    ...
                                    <div class="message-menu message-menu-scroll">
                                        <a class="dropdown-item d-flex" href="chat.html">
                                            <span
                                                ...
                                                data-bs-image-src="{{ url('backend/assets/images/users/1.jpg') }}"></span>
                                            <div class="wd-90p">
                                                <div class="d-flex">
                                        ...
                                        <a class="dropdown-item d-flex" href="chat.html">
                                            <span
                                                class="avatar avatar-md brround me-3 align-self-center cover-image"
                                                data-bs-image-src="{{ url('backend/assets/images/users/15.jpg') }}"></span>
                                            <div class="wd-90p">
                                                <div class="d-flex">
                                        ...
                                        <a class="dropdown-item d-flex" href="chat.html">
                                            <span
                                                class="avatar avatar-md brround me-3 align-self-center cover-image"
                                                data-bs-image-src="{{ url('backend/assets/images/users/12.jpg') }}"></span>
                                            <div class="wd-90p">
                                                <div class="d-flex">
                                        ...
                                        <a class="dropdown-item d-flex" href="chat.html">
                                            <span
                                                class="avatar avatar-md brround me-3 align-self-center cover-image"
                                                data-bs-image-src="{{ url('backend/assets/images/users/4.jpg') }}"></span>
                                            <div class="wd-90p">
                                                <div class="d-flex">
                                        ...
                                        <a class="dropdown-item d-flex" href="chat.html">
                                            <span
                                                class="avatar avatar-md brround me-3 align-self-center cover-image"
                                                data-bs-image-src="{{ url('backend/assets/images/users/3.jpg') }}"></span>
                                            <div class="wd-90p">
                                                <div class="d-flex">
                            ...
                            <div class="dropdown d-flex profile-1">
                                <a href="javascript:void(0)" data-bs-toggle="dropdown" class="nav-link leading-none d-flex">
                                    <img src="{{ url('backend/assets/images/users/21.jpg') }}" alt="profile-user"
                            ...
                            <a href="pos.html" class="nav-link d-flex p-1">
                                <span class="avatar avatar-md brround bg-warning">POS</span>
                             </a>
                             <!-- POS END  -->
                        </div>
                    </div>
